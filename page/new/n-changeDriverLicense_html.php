      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="container-fluid">
            <a class="navbar-brand" href="n-changeDriverLicense_html.php">New driver</a>
          </div>
        </nav>
        <div class="container" id="main">
          <div class="row justify-content-center align-items-center mt-4">
            <div class="col-lg-6 col-lg-offset-4">
              <form action="n-changeDriverLicense.php" method="post">
                ...
                <div class="form-group row mb-3">
                  <label for="input-name" class="col-sm-3 col-form-label" data-validate="Ngày cấp đổi"
                    >Ngày cấp đổi</label
                  >
                  <div class="col-sm-4">
                    <input
                ...
                <div class="form-group row mb-3">
                  <label for="input-lydo" class="col-sm-3 col-form-label"
                    >Lí do đổi</label
                  >
                  <div class="col-sm-9">
                    <input
