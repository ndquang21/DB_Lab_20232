    ...
    <div id="content">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="n-violation_html.php">New Violation</a>
        </div>
      </nav>
      <div class="container" id="main">
        <div class="row justify-content-center align-items-center mt-4">
          <div class="col-lg-6 col-lg-offset-4">
            <form action="n-violation.php" method="post">
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="input-sobanglai" name="input-sobanglai"
                    placeholder="Số bằng lái" required />
                </div>
              </div>
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                  ...
                  min="1900-01-01" max="2123-12-31" required />
                </div>
              </div>
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="input-motavipham" name="input-motavipham"
                    placeholder="Mô tả vi phạm" required />
                </div>
              </div>
              <div class="form-group row mb-3">
