  ...
  <div id="content">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Edit driver</a>
      </div>
    </nav>
    <div class="container" id="main">
      <div class="row justify-content-center align-items-center mt-4">
        <div class="col-lg-6 col-lg-offset-4">
          <form action="e-driver1-chon-cccd.php" method="post">
            <div class="form-group row mb-3">
              <label for="input-cccd" class="col-sm-3 col-form-label">CCCD</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="input-cccd" name="input-cccd" placeholder="Input ID"
                  required />
              </div>
            </div>
